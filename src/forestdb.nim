...
proc fdb_init*(config: ptr fdb_config): fdb_status {.cdecl, importc: "fdb_init",
    dynlib: libforestdb.}
## *
...
proc fdb_get_default_config*(): fdb_config {.cdecl,
    importc: "fdb_get_default_config", dynlib: libforestdb.}
## *
...
proc fdb_get_default_kvs_config*(): fdb_kvs_config {.cdecl,
    importc: "fdb_get_default_kvs_config", dynlib: libforestdb.}
## *
...
proc fdb_open*(ptr_fhandle: ptr ptr fdb_file_handle; filename: cstring;
              fconfig: ptr fdb_config): fdb_status {.cdecl, importc: "fdb_open",
    dynlib: libforestdb.}
## *
##  Open a ForestDB file.
...
proc fdb_open_custom_cmp*(ptr_fhandle: ptr ptr fdb_file_handle; filename: cstring;
                         fconfig: ptr fdb_config; num_functions: csize;
                         kvs_names: cstringArray;
                         functions: ptr fdb_custom_cmp_variable): fdb_status {.
    cdecl, importc: "fdb_open_custom_cmp", dynlib: libforestdb.}
## *
...
proc fdb_set_log_callback*(handle: ptr fdb_kvs_handle;
                          log_callback: fdb_log_callback; ctx_data: pointer): fdb_status {.
    cdecl, importc: "fdb_set_log_callback", dynlib: libforestdb.}
## *
...
proc fdb_set_fatal_error_callback*(err_callback: fdb_fatal_error_callback) {.cdecl,
    importc: "fdb_set_fatal_error_callback", dynlib: libforestdb.}
## *
...
proc fdb_doc_create*(doc: ptr ptr fdb_doc; key: pointer; keylen: csize; meta: pointer;
                    metalen: csize; body: pointer; bodylen: csize): fdb_status {.cdecl,
    importc: "fdb_doc_create", dynlib: libforestdb.}
## *
...
proc fdb_doc_update*(doc: ptr ptr fdb_doc; meta: pointer; metalen: csize; body: pointer;
                    bodylen: csize): fdb_status {.cdecl, importc: "fdb_doc_update",
    dynlib: libforestdb.}
## *
...
proc fdb_doc_set_seqnum*(doc: ptr fdb_doc; seqnum: fdb_seqnum_t) {.cdecl,
    importc: "fdb_doc_set_seqnum", dynlib: libforestdb.}
## *
...
proc fdb_doc_free*(doc: ptr fdb_doc): fdb_status {.cdecl, importc: "fdb_doc_free",
    dynlib: libforestdb.}
## *
...
proc fdb_get*(handle: ptr fdb_kvs_handle; doc: ptr fdb_doc): fdb_status {.cdecl,
    importc: "fdb_get", dynlib: libforestdb.}
## *
...
proc fdb_get_metaonly*(handle: ptr fdb_kvs_handle; doc: ptr fdb_doc): fdb_status {.
    cdecl, importc: "fdb_get_metaonly", dynlib: libforestdb.}
## *
...
proc fdb_get_byseq*(handle: ptr fdb_kvs_handle; doc: ptr fdb_doc): fdb_status {.cdecl,
    importc: "fdb_get_byseq", dynlib: libforestdb.}
## *
...
proc fdb_get_metaonly_byseq*(handle: ptr fdb_kvs_handle; doc: ptr fdb_doc): fdb_status {.
    cdecl, importc: "fdb_get_metaonly_byseq", dynlib: libforestdb.}
## *
...
proc fdb_get_byoffset*(handle: ptr fdb_kvs_handle; doc: ptr fdb_doc): fdb_status {.
    cdecl, importc: "fdb_get_byoffset", dynlib: libforestdb.}
## *
...
proc fdb_set*(handle: ptr fdb_kvs_handle; doc: ptr fdb_doc): fdb_status {.cdecl,
    importc: "fdb_set", dynlib: libforestdb.}
## *
...
proc fdb_del*(handle: ptr fdb_kvs_handle; doc: ptr fdb_doc): fdb_status {.cdecl,
    importc: "fdb_del", dynlib: libforestdb.}
## *
...
proc fdb_get_kv*(handle: ptr fdb_kvs_handle; key: pointer; keylen: csize;
                value_out: ptr pointer; valuelen_out: ptr csize): fdb_status {.cdecl,
    importc: "fdb_get_kv", dynlib: libforestdb.}
## *
...
proc fdb_set_kv*(handle: ptr fdb_kvs_handle; key: pointer; keylen: csize;
                value: pointer; valuelen: csize): fdb_status {.cdecl,
    importc: "fdb_set_kv", dynlib: libforestdb.}
## *
...
proc fdb_del_kv*(handle: ptr fdb_kvs_handle; key: pointer; keylen: csize): fdb_status {.
    cdecl, importc: "fdb_del_kv", dynlib: libforestdb.}
## *
...
proc fdb_free_block*(`ptr`: pointer): fdb_status {.cdecl, importc: "fdb_free_block",
    dynlib: libforestdb.}
## *
...
proc fdb_commit*(fhandle: ptr fdb_file_handle; opt: fdb_commit_opt_t): fdb_status {.
    cdecl, importc: "fdb_commit", dynlib: libforestdb.}
## *
...
proc fdb_snapshot_open*(handle_in: ptr fdb_kvs_handle;
                       handle_out: ptr ptr fdb_kvs_handle;
                       snapshot_seqnum: fdb_seqnum_t): fdb_status {.cdecl,
    importc: "fdb_snapshot_open", dynlib: libforestdb.}
## *
...
proc fdb_rollback*(handle_ptr: ptr ptr fdb_kvs_handle; rollback_seqnum: fdb_seqnum_t): fdb_status {.
    cdecl, importc: "fdb_rollback", dynlib: libforestdb.}
## *
...
proc fdb_rollback_all*(fhandle: ptr fdb_file_handle; marker: fdb_snapshot_marker_t): fdb_status {.
    cdecl, importc: "fdb_rollback_all", dynlib: libforestdb.}
## *
...
proc fdb_iterator_init*(handle: ptr fdb_kvs_handle;
                       `iterator`: ptr ptr fdb_iterator; min_key: pointer;
                       min_keylen: csize; max_key: pointer; max_keylen: csize;
                       opt: fdb_iterator_opt_t): fdb_status {.cdecl,
    importc: "fdb_iterator_init", dynlib: libforestdb.}
## *
...
proc fdb_iterator_sequence_init*(handle: ptr fdb_kvs_handle;
                                `iterator`: ptr ptr fdb_iterator;
                                min_seq: fdb_seqnum_t; max_seq: fdb_seqnum_t;
                                opt: fdb_iterator_opt_t): fdb_status {.cdecl,
    importc: "fdb_iterator_sequence_init", dynlib: libforestdb.}
## *
...
proc fdb_iterator_prev*(`iterator`: ptr fdb_iterator): fdb_status {.cdecl,
    importc: "fdb_iterator_prev", dynlib: libforestdb.}
## *
...
proc fdb_iterator_next*(`iterator`: ptr fdb_iterator): fdb_status {.cdecl,
    importc: "fdb_iterator_next", dynlib: libforestdb.}
## *
...
proc fdb_iterator_get*(`iterator`: ptr fdb_iterator; doc: ptr ptr fdb_doc): fdb_status {.
    cdecl, importc: "fdb_iterator_get", dynlib: libforestdb.}
## *
...
proc fdb_iterator_get_metaonly*(`iterator`: ptr fdb_iterator; doc: ptr ptr fdb_doc): fdb_status {.
    cdecl, importc: "fdb_iterator_get_metaonly", dynlib: libforestdb.}
## *
...
proc fdb_iterator_seek*(`iterator`: ptr fdb_iterator; seek_key: pointer;
                       seek_keylen: csize; direction: fdb_iterator_seek_opt_t): fdb_status {.
    cdecl, importc: "fdb_iterator_seek", dynlib: libforestdb.}
## *
...
proc fdb_iterator_seek_to_min*(`iterator`: ptr fdb_iterator): fdb_status {.cdecl,
    importc: "fdb_iterator_seek_to_min", dynlib: libforestdb.}
## *
...
proc fdb_iterator_seek_to_max*(`iterator`: ptr fdb_iterator): fdb_status {.cdecl,
    importc: "fdb_iterator_seek_to_max", dynlib: libforestdb.}
## *
...
proc fdb_iterator_close*(`iterator`: ptr fdb_iterator): fdb_status {.cdecl,
    importc: "fdb_iterator_close", dynlib: libforestdb.}
## *
...
proc fdb_compact*(fhandle: ptr fdb_file_handle; new_filename: cstring): fdb_status {.
    cdecl, importc: "fdb_compact", dynlib: libforestdb.}
## *
...
proc fdb_compact_with_cow*(fhandle: ptr fdb_file_handle; new_filename: cstring): fdb_status {.
    cdecl, importc: "fdb_compact_with_cow", dynlib: libforestdb.}
## *
...
proc fdb_compact_upto*(fhandle: ptr fdb_file_handle; new_filename: cstring;
                      marker: fdb_snapshot_marker_t): fdb_status {.cdecl,
    importc: "fdb_compact_upto", dynlib: libforestdb.}
## *
...
proc fdb_compact_upto_with_cow*(fhandle: ptr fdb_file_handle; new_filename: cstring;
                               marker: fdb_snapshot_marker_t): fdb_status {.cdecl,
    importc: "fdb_compact_upto_with_cow", dynlib: libforestdb.}
## *
...
proc fdb_cancel_compaction*(fhandle: ptr fdb_file_handle): fdb_status {.cdecl,
    importc: "fdb_cancel_compaction", dynlib: libforestdb.}
## *
...
proc fdb_rekey*(fhandle: ptr fdb_file_handle; new_key: fdb_encryption_key): fdb_status {.
    cdecl, importc: "fdb_rekey", dynlib: libforestdb.}
## *
...
proc fdb_get_buffer_cache_used*(): csize {.cdecl,
                                        importc: "fdb_get_buffer_cache_used",
                                        dynlib: libforestdb.}
## *
...
proc fdb_estimate_space_used*(fhandle: ptr fdb_file_handle): csize {.cdecl,
    importc: "fdb_estimate_space_used", dynlib: libforestdb.}
## *
...
proc fdb_estimate_space_used_from*(fhandle: ptr fdb_file_handle;
                                  marker: fdb_snapshot_marker_t): csize {.cdecl,
    importc: "fdb_estimate_space_used_from", dynlib: libforestdb.}
## *
...
proc fdb_get_file_info*(fhandle: ptr fdb_file_handle; info: ptr fdb_file_info): fdb_status {.
    cdecl, importc: "fdb_get_file_info", dynlib: libforestdb.}
## *
...
proc fdb_get_kvs_info*(handle: ptr fdb_kvs_handle; info: ptr fdb_kvs_info): fdb_status {.
    cdecl, importc: "fdb_get_kvs_info", dynlib: libforestdb.}
## *
...
proc fdb_get_kvs_ops_info*(handle: ptr fdb_kvs_handle; info: ptr fdb_kvs_ops_info): fdb_status {.
    cdecl, importc: "fdb_get_kvs_ops_info", dynlib: libforestdb.}
## *
...
proc fdb_get_latency_stats*(fhandle: ptr fdb_file_handle;
                           stats: ptr fdb_latency_stat;
                           `type`: fdb_latency_stat_type): fdb_status {.cdecl,
    importc: "fdb_get_latency_stats", dynlib: libforestdb.}
## *
...
proc fdb_latency_stat_name*(`type`: fdb_latency_stat_type): cstring {.cdecl,
    importc: "fdb_latency_stat_name", dynlib: libforestdb.}
## *
...
proc fdb_get_kvs_seqnum*(handle: ptr fdb_kvs_handle; seqnum: ptr fdb_seqnum_t): fdb_status {.
    cdecl, importc: "fdb_get_kvs_seqnum", dynlib: libforestdb.}
## *
...
proc fdb_get_kvs_name_list*(fhandle: ptr fdb_file_handle;
                           kvs_name_list: ptr fdb_kvs_name_list): fdb_status {.
    cdecl, importc: "fdb_get_kvs_name_list", dynlib: libforestdb.}
## *
...
proc fdb_get_all_snap_markers*(fhandle: ptr fdb_file_handle;
                              markers: ptr ptr fdb_snapshot_info_t; size: ptr uint64): fdb_status {.
    cdecl, importc: "fdb_get_all_snap_markers", dynlib: libforestdb.}
## *
...
proc fdb_free_snap_markers*(markers: ptr fdb_snapshot_info_t; size: uint64): fdb_status {.
    cdecl, importc: "fdb_free_snap_markers", dynlib: libforestdb.}
## *
...
proc fdb_free_kvs_name_list*(kvs_name_list: ptr fdb_kvs_name_list): fdb_status {.
    cdecl, importc: "fdb_free_kvs_name_list", dynlib: libforestdb.}
## *
...
proc fdb_switch_compaction_mode*(fhandle: ptr fdb_file_handle;
                                mode: fdb_compaction_mode_t; new_threshold: csize): fdb_status {.
    cdecl, importc: "fdb_switch_compaction_mode", dynlib: libforestdb.}
## *
...
proc fdb_close*(fhandle: ptr fdb_file_handle): fdb_status {.cdecl,
    importc: "fdb_close", dynlib: libforestdb.}
## *
...
proc fdb_destroy*(filename: cstring; fconfig: ptr fdb_config): fdb_status {.cdecl,
    importc: "fdb_destroy", dynlib: libforestdb.}
## *
...
proc fdb_shutdown*(): fdb_status {.cdecl, importc: "fdb_shutdown", dynlib: libforestdb.}
## *
...
proc fdb_begin_transaction*(fhandle: ptr fdb_file_handle;
                           isolation_level: fdb_isolation_level_t): fdb_status {.
    cdecl, importc: "fdb_begin_transaction", dynlib: libforestdb.}
## *
...
proc fdb_end_transaction*(fhandle: ptr fdb_file_handle; opt: fdb_commit_opt_t): fdb_status {.
    cdecl, importc: "fdb_end_transaction", dynlib: libforestdb.}
## *
...
proc fdb_abort_transaction*(fhandle: ptr fdb_file_handle): fdb_status {.cdecl,
    importc: "fdb_abort_transaction", dynlib: libforestdb.}
## *
...
proc fdb_kvs_open*(fhandle: ptr fdb_file_handle; ptr_handle: ptr ptr fdb_kvs_handle;
                  kvs_name: cstring; config: ptr fdb_kvs_config): fdb_status {.cdecl,
    importc: "fdb_kvs_open", dynlib: libforestdb.}
## *
...
proc fdb_kvs_open_default*(fhandle: ptr fdb_file_handle;
                          ptr_handle: ptr ptr fdb_kvs_handle;
                          config: ptr fdb_kvs_config): fdb_status {.cdecl,
    importc: "fdb_kvs_open_default", dynlib: libforestdb.}
## *
...
proc fdb_kvs_close*(handle: ptr fdb_kvs_handle): fdb_status {.cdecl,
    importc: "fdb_kvs_close", dynlib: libforestdb.}
## *
...
proc fdb_kvs_remove*(fhandle: ptr fdb_file_handle; kvs_name: cstring): fdb_status {.
    cdecl, importc: "fdb_kvs_remove", dynlib: libforestdb.}
## *
...
proc fdb_error_msg*(err_code: fdb_status): cstring {.cdecl, importc: "fdb_error_msg",
    dynlib: libforestdb.}
## *
...
proc fdb_get_lib_version*(): cstring {.cdecl, importc: "fdb_get_lib_version",
                                    dynlib: libforestdb.}
## *
...
proc fdb_get_file_version*(fhandle: ptr fdb_file_handle): cstring {.cdecl,
    importc: "fdb_get_file_version", dynlib: libforestdb.}
